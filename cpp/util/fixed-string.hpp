...
template <ufull_t N1, ufull_t N2> pure auto
...
template <ufull_t N> struct FixedString {  // NOLINT(altera-struct-pack-align)
...
// Deduction guide
template <ufull_t N> FixedString(char const (&)[N]) -> FixedString<N>;
