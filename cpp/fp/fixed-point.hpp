...
template <ufull_t N, u8 B, i8 I, typename S> struct is_fixed_point_s<fp::a<N, B, I, S>> {
  static constexpr bool value = true;
};
...
template <ufull_t N, u8 B, i8 I, typename S> struct is_fixed_point_array_s<fp::a<N, B, I, S>> {
  static constexpr bool value = true;
};
...
template <ufull_t N, u8 B, i8 I, typename S> class a {
 ...
 private:
  arr_t internal;
  template <ufull_t N2, u8 B2, i8 I2, typename S2> friend class a;
 public:
