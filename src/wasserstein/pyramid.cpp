...
template <vision::pxidx_t w, vision::pxidx_t h>
inline uint8_t& Pyramid<w, h>::operator()(vision::pxidx_t x, vision::pxidx_t y) { return _array[y][x]; }

template <vision::pxidx_t w, vision::pxidx_t h>
inline typename Pyramid<w, h>::up_t& Pyramid<w, h>::up() { return *reinterpret_cast<up_t*>(_up_raw); }
