  ...
  do {
    ...
    if (x < 30000) {
      if (x < 15000) return (x < 6000)
            ? pos_t(-4500, x - 3000)        //     0 -  6000
            : pos_t(x - 10500, 3000);       //  6000 - 15000
      else return (x < 21000)
            ? pos_t(4500, x - 18000)        // 15000 - 21000
            : pos_t(x - 25500, -3000);      // 21000 - 30000
    } else if (x < 48950) {
      if (x < 37650) return (x < 36000)
            ? pos_t(0, x - 33000)           // 30000 - 36000
            : pos_t(x - 40500, -2000);      // 36000 - 37650
      else if (x < 43300) return (x < 41650)
            ? pos_t(-2850, x - 39650)       // 37650 - 41650
            : pos_t(x - 46150, 2000);       // 41650 - 43300
      else return (x < 44950)
            ? pos_t(x - 40450, -2000)       // 43300 - 44950
            : pos_t(2850, x - 46950);       // 44950 - 48950
    } else if (x < 54000) {
      if (x < 51200) return (x < 50600)
            ? pos_t(x - 46100, 2000)        // 48950 - 50600
            : pos_t(x - 55100, 1100);       // 50600 - 51200
      else return (x < 53400)
            ? pos_t(-3900, 52300)           // 51200 - 53400
            : pos_t(x - 57900, -1100);      // 53400 - 54000
    } else if (x < 56800) return (x < 54600)
            ? pos_t(x - 50100, 1100)        // 54000 - 54600
            : pos_t(3900, 55700);           // 54600 - 56800
    else if (x < 57400) return
              pos_t(x - 52900, -1100);      // 56800 - 57400
    // If >= 57400, resample
  } while (true);
}
