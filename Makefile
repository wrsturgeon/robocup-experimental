...
COMMON_FLAGS:=-D_BITS=$$(getconf LONG_BIT) -D_IMAGE_W=1920 -D_IMAGE_H=1080 -D_DISPLAY=${DISPLAY} -I./src -I./eigen -I./naoqi_driver/include $$(sdl2-config --cflags) -march=native -funit-at-a-time -Wall -Wextra -Werror -D_XOPEN_SOURCE=700
