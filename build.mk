...
INCLUDES := -include $(INC)/options.hpp -iquote $(INC) $(shell find include/util -type f ! -name README.md | xargs -I{} echo '-include {}')
...
clang-tidy $(word 2,$(^)) $(word 3,$(^)) --quiet -checks=*,-llvmlibc-*,-llvm-header-guard,-readability-identifier-length,-fuchsia-trailing-return,-hicpp-signed-bitwise,-altera-unroll-loops --warnings-as-errors=* -- $(subst iquote,isystem,$(TEST_CLANG_ARGS)) && \
